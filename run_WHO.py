...
def get_content(url):
    ...
    for child in root: 
        ...
        if child.attrib["class"] == "sf-content-block content-block":
            ...
            print(child.xpath("string()").encode('UTF-8'))

    #utils.get_cprc_tts(story, '/audio',  sample_rate=48000, accent='Irish')



get_content('https://www.who.int/emergencies/diseases/novel-coronavirus-2019/events-as-they-happen')
#help(Document)
